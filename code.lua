...
-- ========================================================================
-- VARIÁVEIS GLOBAIS DE CONFIGURAÇÃO (DATABASE)
-- ========================================================================
local GGPVP = {
    -- COMBATE
    Aimbot = {
    ...
    Recoil = {
        Enabled = false,
        Intensity = 0.5, -- Quanto a câmera desce ao atirar
        Shake = false
    },
    TriggerBot = {
        Enabled = false,
    ...
    ESP = {
        Master = false,
        Boxes = false,
        BoxType = "Corner", -- "Full" ou "Corner"
        Names = false,
        HealthBar = false,
        Distance = false,
        Tracers = false,
        TracerOrigin = "Bottom", -- Top, Mouse, Bottom
    ...
    UI = {
        ...
        ThemeColor = Color3.fromRGB(220, 20, 60), -- Crimson Red
...
-- ========================================================================
-- MOTOR GRÁFICO CUSTOMIZADO (CUSTOM UI LIBRARY)
-- ========================================================================
local Library = {}
local ActiveTab = nil

function Library:CreateWindow(titleText)
    -- Destruir versão anterior para não sobrepor
    ...
    MainFrame.Draggable = true -- Arrastar janela nativo
    ...
    function WindowObj:Notify(title, text)
        -- Notificação Customizada Integrada
...
-- ========================================================================
-- CONSTRUÇÃO DA INTERFACE (UI BUILDING)
-- ========================================================================
...
-- ========================================================================
-- SISTEMAS DRAWING (FOV, CROSSHAIR, RADAR)
-- ========================================================================
...
-- ========================================================================
-- LÓGICA CORE (AIMBOT, ESP, RECOIL, ETC)
-- ========================================================================
...
-- ========================================================================
-- SISTEMA DE DESENHO DO ESP (PROFISSIONAL)
-- ========================================================================
        ...
        if p ~= LP then
            ...
            if GGPVP.ESP.Master and char and char:FindFirstChild("HumanoidRootPart") and char:FindFirstChild("Humanoid") then
                ...
                if onScreen and hum.Health > 0 then
                    ...
                    -- BARRA DE VIDA (DEGRADÊ INTELIGENTE)
...
-- ========================================================================
-- LOOPS E EVENTOS PRINCIPAIS (AIMBOT & FISICA)
-- ========================================================================
...
RunService.RenderStepped:Connect(function()
    ...
    -- Controle de Recuo (Anti-Recoil simulado na Câmera)
